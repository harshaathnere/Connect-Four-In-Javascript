document.addEventListener('DOMContentLoaded',() =>{
 ...
 const winningArray =[
    ...
    for (let y =0; y< winningArray.length; y++){
       ...
       const square2 = square[winningArray[y][1]]
       const square3 = square[winningArray[y][2]]
       const square4 = square[winningArray[y][3]]
       // check tnose square if they all have the class of the player one
    ...
    // check tnose square if they all have the class of the player Two
